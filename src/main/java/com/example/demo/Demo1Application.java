...
public class Demo1Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		ItemPedido ip1 = new ItemPedido(ped1, p1, 0.00, 1, BigDecimal.valueOf(2000.00));
		ItemPedido ip2 = new ItemPedido(ped1, p3, 0.00, 2, BigDecimal.valueOf(80.00));
		ItemPedido ip3 = new ItemPedido(ped2, p2, 100.00, 1, BigDecimal.valueOf(800.00));
