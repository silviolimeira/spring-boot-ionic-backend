...
public class ClienteNewDTO implements Serializable {
	...
	@NotEmpty(message="Logradouro de Preenchimento obrigatório")
	private String logradouro;

	@NotEmpty(message="Número de Preenchimento obrigatório")
    ...
    @Min(value=1, message="Cidade deve estar cadastrada")  
